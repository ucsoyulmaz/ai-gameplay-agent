...
player package/class specifications (positional arguments):
  ...
  your top-level package (i.e. 'the_black_mamba').
  ...
  with import statements, e.g. 'the_black_mamba.player2') or relative path (to a
  file or directory containing the Python module, e.g. 'the_black_mamba/player3'
  or 'the_black_mamba/players/player4.py').
  ...
  (e.g. 'the_black_mamba:DifferentPlayer').
